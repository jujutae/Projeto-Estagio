...
<nav class="navbar navbar-expand-lg bg-body-tertiary" style="background-color:rgb(14, 131, 214);" data-bs-theme="light">
  <a class="navbar-brand" href="#">
    <img src="ifto-logo.png" alt="Logo IFTO" height="40">
  </a>
