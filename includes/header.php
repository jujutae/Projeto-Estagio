...
$usuario = $alunoLogado ?
  '<button type="button" class="btn btn-primary me-2">'.$alunoLogado['nome'] . '</button>
  ...
  <button type="button" class="btn btn-outline-primary me-2"><a href="/si/login.php">Entrar</a></button>'
